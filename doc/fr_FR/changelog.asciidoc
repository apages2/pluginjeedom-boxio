...
Ajout de la gestion des statuts des inter scenario
Ajout des modules 43214, 67220,77023 et 77024
Modification des templates pour intégrer les generic_type (necessaire à l'appli mobil)
Ajout de la gestion des statuts pour l'alarme multifonction 43214 
Ajout d'un fonction pour mettre a jour les templates via github sans pousser une nouvelle release de boxio
Modification de l'affichage de l'equipement pour connaitre la version installé/disponible du template, ainsi qu'une courte description des changements de la nouvelle version du template
