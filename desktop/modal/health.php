...
$eqLogics = boxio::byType('boxio');
?>

<table class="table table-condensed tablesorter" id="table_healthboxio">
	<thead>
		<tr>
			<th>{{Image}}</th>
			<th>{{Module}}</th>
...
foreach ($eqLogics as $eqLogic) {
	...
	if (file_exists(dirname(__FILE__) . '/../../core/config/devices/' . $alternateImg . '.jpg')) {
		$img = '<img class="lazy" src="plugins/boxio/core/config/devices/' . $alternateImg . '.jpg" height="65" width="55" />';
