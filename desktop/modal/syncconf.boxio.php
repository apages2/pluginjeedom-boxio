...
?>
<div id='div_syncconfBoxioAlert' style="display: none;"></div>
...
<br/><br/><br/>
<pre id='pre_boxiosyncconf' style='overflow: auto; height: 90%;with:90%;'></pre>
...
<script>
	$.ajax({
		...
		data: {
			action: 'syncconfBoxio',
		},
		dataType: 'json',
		global: false,
		error: function (request, status, error) {
			handleAjaxError(request, status, error, $('#div_syncconfBoxioAlert'));
		},
		success: function () {
			jeedom.log.autoupdate({
				log : 'boxio.syncconf',
				display : $('#pre_boxiosyncconf'),
